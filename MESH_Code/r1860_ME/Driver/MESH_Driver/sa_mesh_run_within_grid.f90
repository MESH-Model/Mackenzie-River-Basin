...
!        if (allocated(vs%grid%pre)) vs%grid%pre(i1:i2) = 0.0
        ...
        if (allocated(vs%grid%uvcan)) vs%grid%uvcan(i1:i2) = 0.0	!ME
...
!        if (allocated(vs%grid%hcps)) vs%grid%hcps(i1:i2, :) = 0.0	! ME
...
!            end if
            ...
            if (allocated(vs%grid%uvcan) .and. allocated(vs%tile%uvcan)) then    ! ME
...
!-            end if
            ...
            ! if (allocated(vs%grid%hcps) .and. allocated(vs%tile%hcps)) then   ! ME
