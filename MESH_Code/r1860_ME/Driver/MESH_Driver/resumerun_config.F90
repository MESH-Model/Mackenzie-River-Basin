...
! ME Changed the behaviour of the auto resume to "resume on" instead of "off"
            ...
            call print_message("RESUMEFLAG is revised: RESUMEFLAG on with the settings shown above")
