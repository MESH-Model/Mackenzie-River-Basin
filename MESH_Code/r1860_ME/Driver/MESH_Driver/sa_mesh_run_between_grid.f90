...
!-        end if
        ...
        ! if (allocated(vs%basin%hcpg) .and. allocated(vs%grid%hcpg)) then
            ...
            ! end if
        ! end if	
        ! if (associated(vs%basin%tctopc) .and. associated(vs%grid%tctopc)) then
            ...
            ! end if
        ! end if			
        ! if (associated(vs%basin%tctopg) .and. associated(vs%grid%tctopg)) then
            ...
            ! end if
        ! end if	
        ! if (associated(vs%basin%tcbotc) .and. associated(vs%grid%tcbotc)) then
            ...
            ! end if
        ! end if	
        ! if (associated(vs%basin%tcbotg) .and. associated(vs%grid%tcbotg)) then
